// Reflection API : 클래스 정보를 얻는 방식, "for name",  "class"라는 스태틱 변수
...
public class Exam03 {
  ...
  public static void main(String[] args) throws Exception {
    // Class clazz1 = Class.forName("com.eomcs.reflect.ex01.Exam03$A");
