...
public class Exam0130 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //   <select id="selectBoard3" resultType="Map" parameterType="int">...</select>
    //    select 
    //    board_id, 
    //    title,    
    //    contents,
    ...
    // - 컬럼 이름으로 컬럼 값을 저장하기 때문에
    // map 객체에 컬럼 값을 꺼낼 때 컬럼 이름 또는 별명을 사용해야 한다.
    //

    Map<String,Object> map = sqlSession.selectOne("BoardMapper.selectBoard3",8);
