...
public class Exam0521 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 바이트 배열에 저장된 문자 코드를 JVM이 사용하는 문자 집합(USU2=UTF168E)의 코드 값으로 변환된다.
    // 바이트가 배열에 들어가 있있는 코드 값이 어떤 문자 집합의 값인지 알려주지 않는다면?
    // JVM 환경 변수 file.encoding에 설정된 문자 집합으로 가정하라고 변환을 수행한다.
